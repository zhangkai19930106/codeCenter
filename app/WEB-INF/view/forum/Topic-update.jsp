...
<b:notice/>
<b:appletBox title="修改主题" showMM="false"/>
<s:actionerror/>
<s:form action="Topic!doUpdate" name="postForm" id="postForm">
    <b:inputHidden name="forumArticle.articleId" value="forumArticle.articleId"/>
    <b:inputHidden name="forumArticleId" value="forumArticle.replyArticle==null?forumArticleId:forumArticle.replyArticle.articleId"/>
        <p>
			<s:textfield id="articleTitleTxt" cssStyle="width:460px" name="forumArticle.articleTitle" label="主题标题" readonly="true" cssClass="{required:true,maxlength:100, messages:{required:'请输入主题标题'}}" />
		</p>
	...
	<b:inputHtml value="&nbsp;&nbsp;"/>
	<b:inputButton value="取消" onclick="window.location='Topic!allList.action?forumArticleId=${forumArticle.replyArticle==null?forumArticleId:forumArticle.replyArticle.articleId }';return false;"/>
	</div>
</s:form>
