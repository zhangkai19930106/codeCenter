...
<body>
	<b:appletBox title="新增用户扩展属性" showMM="false" />
	<s:actionerror />
	<s:form action="UserExtConf!doCreate" validate="true" cssClass="notTipError" id="form1">
		<p>
			<s:textfield name="userExtConf.extCode" label="属性编码" cssClass="{required:true,maxlength:30,wordinput:true,remote:{url:'UserExtConf!validUserExtConfId.action',type:'post',data:{'extCode':function (){return $j('#form1_userExtConf_extCode').val();}}}, messages:{required:'请输入属性编码',remote:'该属性编码已存在'}}" />
		</p>
		<p>
